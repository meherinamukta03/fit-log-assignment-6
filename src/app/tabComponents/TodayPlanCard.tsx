...
const TodayPlanCard = ({ work }: IProps) => {
    return (
        <div className="w-full overflow-hidden rounded-xl border border-[#25272c] bg-[#15171c] p-3">
            ...
            {/* Buttons */}
            <div className="mt-3 flex w-full flex-col items-stretch gap-2 border-t border-[#25272c] pt-3 sm:flex-row sm:items-center sm:justify-end sm:border-0 sm:pt-0">
